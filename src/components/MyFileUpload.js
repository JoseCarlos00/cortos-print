class MyFileUpload extends HTMLElement {
	connectedCallback() {
		this.innerHTML = /*html*/ `
        ...
        <div class="container-file-upload-form"">
          ...
          <label for="fileInput" class="file-upload-label">
            <div class="file-upload-design">
              ...
              <p class="file-upload-label-text">Arrastrar y soltar</p>
              <p class="file-upload-label-text">o</p>
...
customElements.define('my-file-upload', MyFileUpload);
